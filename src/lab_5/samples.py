...
#
# path = Path(r"C:\Users\eniko\PycharmProjects\PythonProject\data\samples\people.json")
...
# ]
# path = Path(r"C:\Users\eniko\PycharmProjects\PythonProject\data\samples\cities.csv")
